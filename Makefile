...
#                                                 +#+#+#+#+#+   +#+            #
#    Created: 2017/06/23 10:34:45 by cramorok          #+#    #+#              #
#    Updated: 2017/06/24 15:08:52 by cramorok         ###   ########.fr        #
#                                                                              #
# **************************************************************************** #
...
SRCS 	= ft_atoi.c			ft_bzero.c		ft_memcpy.c		ft_memccpy.c	\
	  ...
	  ft_strsplit.c		ft_lstmap.c		ft_lstadd.c		ft_lstiter.c	\
	  ft_lstdel.c		ft_lstdelone.c	ft_ishexa.c		ft_lstnew.c		\
	  ft_isspace.c		ft_ishexa.c		ft_intlen.c		ft_swap.c		\
	  ft_atobin.c		ft_sort_int_tab.c	\
